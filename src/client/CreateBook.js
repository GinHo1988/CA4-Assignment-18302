                    ...
                    <div className="columns">
                        ...
                        <div className="column">
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input is-small" type="date" name="Publish" value={this.state.Publish} onChange={this.handleChange} id="form" />
                                </div>
                            </div>
                            <div className="field">
                                <label className="label"> Comment: </label>
                                <div className="control">
                                    <input className="input is-small" type="text" name="Comment" value={this.state.Comment} onChange={this.handleChange} id="form" />
                                </div>
                            </div>
                        </div>
                    </div>
