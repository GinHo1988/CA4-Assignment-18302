          ...
          <div className="card-content">
            <div className="media">
              <div className="media-content">
                ...
                <hr/>
                <label className="label"> Author: <div className="subtitle is-size-6">{this.props.Author}</div></label>
                <label className="label"> Publish: <p className="subtitle is-size-6">{this.props.Publish}</p></label>
                <label className="label"> Comment: <p className="subtitle is-size-6">{this.props.Comment}</p></label>
